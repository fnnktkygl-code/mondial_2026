...
// ─── Live Data API ─────────────────────────────────────────────────────────────
// Source: ESPN (Scoreboard & Summary APIs)
// ─── Hive box names ──────────────────────────────────────────────────────────
...
const String kHiveBoxPredictions =
    'mondial_predictions'; // key = fixture_id (int → String)

// ─── Network / Cache ─────────────────────────────────────────────────────────
const Duration kApiTimeout = Duration(seconds: 8);
const Duration kCacheRefreshInterval = Duration(
  minutes: 5,
); // TTL cache fixtures (live)
const Duration kLivePollInterval = Duration(
  seconds: 15,
); // polling pendant un match
