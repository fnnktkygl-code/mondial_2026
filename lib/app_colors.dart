...
class AppColors {
  ...
  static const Color borderMid = Color(
    0xFF334155,
  ); // Mid-emphasis border / divider
  static const Color borderStrong = Color(
    0xFF475569,
  ); // Stronger border / inactive
  ...
  static const Color accentLight = Color(
    0xFFD1FAE5,
  ); // Pulse highlight / lightest green
  ...
  static const Color textDim = Color(
    0xFF8A99AD,
  ); // Very dim / placeholder / captions
