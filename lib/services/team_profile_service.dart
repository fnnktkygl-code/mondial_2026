...
class WCTeamProfileService {
  ...
  static TeamProfileData getProfile(String code, String lang) {
    ...
    final profileUrl = mediaEntry?['profile_url'] ?? 'https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/articles/$cleanCode-team-profile-history';
  ...
  static String _getBestFinish(String code, String lang) {
    final Map<String, Map<String, String>> finishes = {
      ...
      'cu': {'fr': 'Premier Tournoi en 2026', 'en': 'Tournament Debut in 2026', 'es': 'Debut en el Torneo en 2026'},
