...
class BracketViewWidget extends StatelessWidget {
  ...
  Widget _buildBracketTeamRow({required String code, required int score, required bool isWinner, required bool isLoser}) {
    final isPlaceholder = code.length > 2 && code.toLowerCase() != 'sco' || code.toLowerCase() == 'tbd' || code.contains(RegExp(r'\d'));
                ...
                Expanded(
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          AppTranslations.getTeam(lang, code),
                          style: TextStyle(
                            color: isPlaceholder ? AppColors.textDim : (isWinner ? Colors.white : isLoser ? AppColors.borderStrong : AppColors.textSecondary),
