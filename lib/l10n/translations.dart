  ...
  static const Map<String, Map<String, dynamic>> _data = {
    'fr': {
      ...
      'jokes': {
        ...
        'deleteGroupConfirm': 'Êtes-vous sûr de vouloir supprimer ce groupe pour tout le monde ?',
    ...
    'en': {
      ...
      'teams': {
        ...
        'deleteGroupConfirm': 'Are you sure you want to delete this group for everyone?',
        'leaveGroupTitle': 'Leave Group',
        'leaveGroupConfirm': 'Are you sure you want to leave this group?',
        'profileLockPrompt': 'Lock your champion & top scorer in your profile ↗',
        'pointsBadge': '+ {pts} PTS',
    ...
    'es': {
      ...
      'teams': {
        ...
        'deleteGroupConfirm': '¿Estás seguro de que deseas eliminar este grupo para todos?',
      ...
      'predictionLockMsg':  "Para garantizar la equidad entre todos los jugadores, ningún pronóstico puede modificarse tras el pitido inicial.",
