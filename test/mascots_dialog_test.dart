...
void main() {
  testWidgets('WCMascotsDialog builds and displays mascots', (WidgetTester tester) async {
    ...
    expect(find.text('Goalkeeper & Creative Artist'.toUpperCase()), findsOneWidget);
